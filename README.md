...
2. Navigate to the project's root directory (`warehouse-brain`).
...
2. Run the command: `python module_a_planning/plan.py`
...
**How to run:**
1. Ensure your terminal is in the project root directory.
2. Run the command: `python module_b_uncertainty/compare.py`
...
**How to run:**
1. Ensure your terminal is in the project root directory.
2. To run the game simulation, execute: `python module_c_game/dock_game.py`
3. To generate search space benchmarks, execute: `python module_c_game/benchmark_chart.py`
...
3. Open the file `module_d_connectionist/anomaly_notebook.ipynb` and run the cells.
4. Alternatively, you can run the test suite by executing: `pytest module_d_connectionist/tests/test_connectionist.py`
...
**How to run:**
1. Ensure your terminal is in the project root directory.
2. To launch the interactive diagnostic advisor, run: `python module_e_expert_system/expert_advisor.py`
3. To run the interactive knowledge acquisition tool, run: `python module_e_expert_system/knowledge_acquisition.py`
